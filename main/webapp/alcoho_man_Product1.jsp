    ...
    <div class="row">
        ...
        <%
            ...
            try {
                ...
                // SQL 쿼리 준비
                String query = "SELECT image_url FROM products";
        ...
        <div class="col-md-6 product-details">
            <h2 class="product-name">Kahlua</h2>
            <p class="product-category">Liqueur</p>
            <p><strong>알코올 함량:</strong> 20%</p>
            <p><strong>가격:</strong> 34,500원</p>
            <div class="mb-3">
                <button class="btn btn-primary mb-2">장바구니</button>
                <button class="btn btn-secondary mb-2">바로구매</button>
            </div>
            <p class="product-info">럼 기반의 멕시코의 커피 리큐르이며 Acolhua(사람들의 집)을 의미합니다.</p>
        </div>
    </div>
</div>
